...
describe('Solana-Simple-Keyring', function () {
  describe('SimpleKeyring runs normally', function () {
    it('addAccounts() runs normally', async function () {
      let sk = new SimpleKeyring();
